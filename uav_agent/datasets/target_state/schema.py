...
class TargetTrainingLabel:
    ...
    # None is the legacy schema. New captures explicitly distinguish target
    # visibility from whether its true geometric centre is inside the image.
    center_in_image: bool | None = None

    def __post_init__(self) -> None:
        if not isinstance(self.visible, bool):
            raise TypeError("target_label.visible must be bool")
        if self.center_in_image is not None and type(self.center_in_image) is not bool:
            raise TypeError("target_label.center_in_image must be bool or None")
    ...
    def to_dict(self) -> dict[str, object]:
        ...
        if self.center_in_image is not None:
            payload["center_in_image"] = self.center_in_image
        return payload
...
class TargetStateFrameRecord:
    ...
    # Optional offline supervision metadata. Never a sensor/model feature.
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.association_review_required, bool):
            raise TypeError("association_review_required must be bool")
    ...
    def to_dict(self) -> dict[str, object]:
        ...
        # Preserve legacy serialized records and dataset hashes exactly.
        if self.association_review_required:
            payload["association_review_required"] = True
        return payload
    ...
    def from_dict(cls, payload: Mapping[str, object]) -> "TargetStateFrameRecord":
        ...
        if set(payload) - {"association_review_required"} != expected:
        ...
        return cls(
            association_review_required=payload.get("association_review_required", False),
            ...
            training_label=(
                ...
                if label is None
                    ...
                    center_in_image=label.get("center_in_image"),
                )
            ),
        )
